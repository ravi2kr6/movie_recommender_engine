...
<head>
    ...
    <title>Movie Recommendation Engine:Colloborative Rating</title>
  ...
  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-control="navbar">
    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="collob.php">Colloborative Prediction</a></li>
...
<div class="wrapper" style="margin-top: 50px;">
    ...
    <th>Genre</th>
            ...
            //show records
            $query = mysql_query("SELECT * FROM predicted_rating ORDER BY rating desc LIMIT $startpoint , $limit");
